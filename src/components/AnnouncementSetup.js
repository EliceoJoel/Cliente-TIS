...
export class AnnouncementSetup extends Component {
    ...
    handleAux(e) {
        e.preventDefault()
        this.setState({ item_error: '', auxiliary_error: '', add_auxiliary: '', remove_auxiliary: '' })
        if (this.validAnnouncementAuxiliary()) {
            ...
            this.handleTableAuxiliary()
        }

    }
    handleTheme(e) {
        e.preventDefault()
        this.setState({ add_tematica: '', remove_tematica: '' })
        if (this.validAnnouncementTheme()) {
    ...
    handleMerit(e) {
        e.preventDefault()
        this.setState({ add_merit: '', remove_merit: '', merit_error: '' })
        if (this.validAnnouncementMerit()) {
    ...
    handleRequirementConfiguration(e) {
        ...
        this.setState({
            ...
            requirement_error: '',
            add_requirement_warning: '',
            remove_requirement_warning: '', requirement: ''
        })
        this.handleTableRequirement()
    ...
    handleAuxConfiguration(e) {
        ...
        this.setState({
            ...
            showTheme: false,
            showPercentage: false,
            add_auxiliary: '', remove_auxiliary: '', item_error: '', auxiliary_error: ''
    ...
    handleMeritConfiguration(e) {
        ...
        this.setState({
            ...
            showMerit: true,
            showTheme: false,
            showPercentage: false, merit_error: '', nameMerit: '', add_merit: '', remove_merit: ''
    ...
    handleThemeConfiguration(e) {
        ...
        this.setState({
            ...
            showMerit: false,
            showTheme: true,
            showPercentage: false, tematica: ' ', tematica_error: '', add_tematica: '', remove_tematica: ''
    ...
    validAnnouncementMerit() {
        if (this.state.nameMerit === '') {
            this.setState({ merit_error: 'Campo Vacio' })
        }
        else {
            return true;
        }
    }
    validAnnouncementTheme() {
        if (this.state.tematica === '') {
            this.setState({ tematica_error: 'Campo Vacio' })
        }
        else {
            return true;
        }
    ...
    handleRemoveRequirement(e) {
        ...
        axios({
            ...
            console.log(res);
            this.setState({ remove_requirement_warning: 'se elimino el elemento con exito' })
        })
            .catch(error => {
                console.log(error)
    ...
    handleRemoveAuxiliary(e) {
        this.setState({ add_auxiliary: '', remove_auxiliary: '' })
        ...
        axios({
            ...
            console.log(res);
            this.setState({ remove_auxiliary: 'se elimino la auxiliatura con exito' })
        })
            .catch(error => {
                console.log(error)
    ...
    handleRemoveMerit(e) {
        this.setState({ add_merit: '', remove_merit: '' })
        let idMerit = e.id
        let send = new FormData()
        ...
        axios({
            ...
            console.log(res);
            this.setState({ remove_merit: 'Se elimino el elemento con exito' })
        })
            .catch(error => {
                console.log(error)
    ...
    handleRemoveTheme(e) {
        ...
        axios({
            ...
            console.log(res);
            this.setState({ remove_tematica: 'se elimino la tematica con exito' })
        })
            .catch(error => {
                console.log(error)
                            ...
                            <div className="row">
                                <div className="col-md-12">
                                    ...
                                    <div className="form-group col-md-12 ">
                                        ...
                                        <p style={{ color: "green" }}>{this.state.add_requirement_warning}</p>
                                        <p style={{ color: "red" }}>{this.state.remove_requirement_warning}</p>
                                    </div>
                                </div>
                                <div className="col-md-12">
                                    <br></br>
                    ...
                    {this.state.showAuxiliary ?
                        <div className="row">
                            ...
                            <div className="form-group col-md-12 ">
                                ...
                                <p style={{ color: "green" }}>{this.state.add_auxiliary}</p>
                                <p style={{ color: "red" }}>{this.state.remove_auxiliary}</p>
                            ...
                            <div className="row">
                                ...
                                <div className="form-group col-md-12">
                                    ...
                                    <input
                                        ...
                                        onChange={this.onChangeAux}
                                    />
                                    <p style={{ color: "red" }}>{this.state.tematica_error}</p>
                                </div>

                                <div className="form-group col-md-12 ">
                                    <button className="btn btn-outline-info" variant="warning" onClick={(e) => this.handleTheme(e)} >Agregar</button>
                                    <p style={{ color: "green" }}>{this.state.add_tematica}</p>
                                    <p style={{ color: "red" }}>{this.state.remove_tematica}</p>
                                </div>
                                <div className="col-md-12">
                                    <br></br>
                    ...
                    {this.state.showMerit ?
                        <div className="row">
                            ...
                            <div className="form-group col-md-12 ">
                                ...
                                <p style={{ color: "green" }}>{this.state.add_merit}</p>
                                <p style={{ color: "red" }}>{this.state.remove_merit}</p>
                            </div>
                            <div className="col-md-12">
                                <br></br>
